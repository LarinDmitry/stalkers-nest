...
import { IsString, IsNumber, Min, Matches, ValidateIf } from 'class-validator';
...
export class CreateStatisticDto {
  ...
  @ValidateIf(({total}) => typeof total === 'number' || typeof total === 'string')
  @Matches(/^\d+$/, { message: 'Total must contain only digits' })
